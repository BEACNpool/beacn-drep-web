...
Recommendation: **NO**
Score: `-0.2533` (raw `-0.2233` + doctrine-LLM nudge `-0.03`) | Confidence: `0.7333` | Readiness: `0.85`
...
BEACN records NO on Cardano x Draper Dragon: Orion Fund. On the evidence available to BEACN's published review, the request does not clear the bar for spending shared treasury funds.
...
A material claim remains proposer-asserted or thinly supported: Importantly, the Orion Fund is structured so that Treasury exposure is incremental, capped, and fully governed.
...
## Reproducibility
- input_hash: `af46da0837b2e5dcecea7190a1044d0299bbc422c2f84f2826ff662bf8c10c7c`
- snapshot_bundle_hash: `92c7a5f24378e401603d5c50298814bc1ceb73f77c9a9d60044516c397058eb9`
...
- decision_probs: `{"ABSTAIN": 0.2164, "NO": 0.7362, "YES": 0.0474}`
