...
> Reasoning layer (precomputed): The claims describe potentially high public-benefit infrastructure, but several high-materiality delivery, security, adoption, and current-state assertions remain mostly proposer-asserted within a deterministic assessment that labels evidence thin and overall status incomplete. Under BEACN doctrine, this supports only a small cautionary nudge rather than a directional rejection, because incomplete diligence is a needs-more-info state rather than evidence of waste or harm.
...
- finding: Requested: Phase 1 of 2 for Bifrost, taking a Bitcoin-Cardano bridge from working testnet to launch readiness through hardening, security audits, formal verification, ecosystem and partner readiness, stewardship, and economic foundations.
- finding: Recipient: FluidTokens and Lantr Engineering
- finding: Stated amount: 12332031
- finding: Deliverables: Audited bridge running on Cardano mainnet under controlled access, Federated and SPO-threshold custody modes, Security audits and formal verification, Hardened economic model, Stewardship structure determined for launch, SPO and dApp partner pipeline for public launch, Public launch and 24 months of operations deferred to Phase 2 in Q1 2027
...
- finding: Claim (adoption, independently_verifiable, medium materiality): Catalyst Fund 14 funded Bifrost for ₳739,000 with deliverables covering architecture, testnet MVP, and documentation on a December 2025 to August 2026 timeline stated as on track.
- finding: Claim (technical, supported_in_proposal, high materiality): Bifrost custody of locked BTC is intended to be distributed across 400+ Cardano SPOs weighted by delegation, with fund movement requiring a cryptographic threshold representing a majority of delegated stake.
...
- missing: Independent evidence for: If SPO coordination fails, Bifrost includes a federated mode as an operational fallback.
- missing: Independent evidence for: Bifrost smart contracts, off-chain tooling, and SDK are claimed to be released under Apache 2.0 and usable for auditing, forking, running, or building without permission.
...
## Inferences
- Advisory model lean was -0.020 (display cap ±0.05) and had zero influence on the binding score: The claims describe potentially high public-benefit infrastructure, but several high-materiality delivery, security, adoption, and current-state assertions remain mostly proposer-asserted within a deterministic assessment that labels evidence thin and overall status incomplete. Under BEACN doctrine, this supports only a small cautionary nudge rather than a directional rejection, because incomplete diligence is a needs-more-info state rather than evidence of waste or harm.
...
## Reproducibility
- input_hash: `bbfe97aa65f5e272345496f72e164c160f6039542d1c02aca987d5dc1f3df3c2`
- snapshot_bundle_hash: `fe8422897d40c74f79e01e35ee3a54f7553bde4f9dc53bb12a75ad850057f153`
