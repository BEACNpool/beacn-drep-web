...
> Reasoning layer (precomputed): The extracted claims show some concrete scope, addresses, governance references, and oversight mechanics, but the assessment remains blocked because core treasury diligence is missing, including complete budget analysis, feasibility assessment, risk analysis, alternatives analysis, and failure-mode analysis. Under a treasury withdrawal standard, that evidence gap justifies a small cautionary nudge rather than a positive adjustment.
...
The action is a TreasuryWithdrawals. The cached anchor describes the request as: Fund UTxO RPC by TxPipe for Year 2 maintenance and enhancement over 12 months, submitted by Intersect on behalf of the vendor.. The recorded treasury amount is 540750. The strongest grounded claim is: The proposal requests 540,750 ADA total, consisting of 525,000 ADA for UTxO RPC maintenance and enhancement and a 15,750 ADA Intersect Budget Administration fee.
...
- finding: Requested: Fund UTxO RPC by TxPipe for Year 2 maintenance and enhancement over 12 months, submitted by Intersect on behalf of the vendor.
...
- finding: Deadline/expiry: 12 months after the new grant period begins following closure of the existing contract
...
- finding: Claim (economic, supported_in_proposal, high materiality): The motivation states the project budget includes 420,000 ADA plus a 105,000 ADA contingency reserve to fund a part-time UTxO RPC maintainer at an annual rate of $105,000 USD.
...
- finding: Claim (technical, independently_verifiable, medium materiality): The project is said to maintain more than 10 repositories covering the core specification, SDKs, documentation, and provider integrations under the Apache 2.0 license.
- finding: Claim (governance, independently_verifiable, high materiality): The proposal states it achieved the required 67% support threshold in the 2026 Intersect Budget Process Hydra Voting phase and was advanced for on-chain Treasury Withdrawal submission under the approved framework.
...
## Inferences
- Doctrine-aware reasoning layer nudged the score by -0.030 (clamped to ±0.05): The extracted claims show some concrete scope, addresses, governance references, and oversight mechanics, but the assessment remains blocked because core treasury diligence is missing, including complete budget analysis, feasibility assessment, risk analysis, alternatives analysis, and failure-mode analysis. Under a treasury withdrawal standard, that evidence gap justifies a small cautionary nudge rather than a positive adjustment.
...
## Reproducibility
- input_hash: `0cda07fb052445b4c7bd4a1ae9a586e4d744a60178f10afb2c64917314140b36`
- snapshot_bundle_hash: `1c8af45b53f713a7f4fc4b2adf6b5bc1f1bc535dd38fae218fc571106057924f`
