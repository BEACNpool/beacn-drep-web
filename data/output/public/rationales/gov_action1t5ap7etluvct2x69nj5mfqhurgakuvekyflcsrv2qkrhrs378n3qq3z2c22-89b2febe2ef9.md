...
> Reasoning layer (precomputed): The proposal aligns with the info-action goal of improving governance clarity, but the evidence base is thin and several high-materiality claims about dysfunction and existential harm are asserted without supporting detail. Because the deterministic assessment already flags thin claims and incomplete status, only a small cautionary nudge is justified.
...
- finding: Deliverables: Sketch basic ideas for reforming treasury governance, Introduce those ideas into public discussion, Outline guardrails for strategic direction
...
- finding: Claim (governance, proposer_asserted, high materiality): The proposal claims current treasury withdrawal voting has created perceived competition for scarce resources, hostility, conflict, toxicity, ill will, and strife within the community.
...
- finding: Claim (governance, proposer_asserted, medium materiality): The proposal argues the Net Change Limit should not be treated as a potential overall budget because it is only a vague approximation and insufficient without coherent treasury withdrawals.
- finding: Claim (economic, supported_in_proposal, high materiality): The proposal recommends a dedicated investment budget that includes strategic direction, a roadmap, thematic domains, overall amount, budget structure, and allocation percentages.
...
- missing: Independent evidence for: The proposal claims current treasury withdrawal voting has created perceived competition for scarce resources, hostility, conflict, toxicity, ill will, and strife within the community.
...
- missing: Independent evidence for: The proposal argues the Net Change Limit should not be treated as a potential overall budget because it is only a vague approximation and insufficient without coherent treasury withdrawals.
...
## Inferences
- Doctrine-aware reasoning layer nudged the score by -0.010 (clamped to ±0.05): The proposal aligns with the info-action goal of improving governance clarity, but the evidence base is thin and several high-materiality claims about dysfunction and existential harm are asserted without supporting detail. Because the deterministic assessment already flags thin claims and incomplete status, only a small cautionary nudge is justified.
...
- Claims and evidence missing: Independent evidence for: The proposal claims current treasury withdrawal voting has created perceived competition for scarce resources, hostility, conflict, toxicity, ill will, and strife within the community.
- Claims and evidence status is thin.
- Risk review missing: mitigation evidence
- Risk review missing: independent assurance

## Reproducibility
- input_hash: `89b2febe2ef951282b2b5cd6e9ecdd1d887fe9ab06e222ae6163918eb5244061`
- snapshot_bundle_hash: `ab9c24f468a8a4c4de7d855f3d4afb7374a7a92abc9c9080824238ee7f0d3b18`
