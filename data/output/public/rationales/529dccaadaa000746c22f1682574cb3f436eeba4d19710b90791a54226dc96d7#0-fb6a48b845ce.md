...
Recommendation: **NO**
Score: `-0.15` (binding treasury composite; advisory raw signal `-0.15`; LLM lean `+0.0` recorded, not added) | Confidence: `0.7875` | Readiness: `0.65`
...
## Uncertainty
- Treasury flow signal is in unsustainable regime, ratio 2.13 (total inflow (tau + donations) vs enacted withdrawals); advisory penalty applied.
...
## Reproducibility
- input_hash: `fb6a48b845cee47b1dc939d035b1993377c248197334dddd68d1d65f366594af`
- snapshot_bundle_hash: `64e4324ec89cde712e0fe8cce9bced90fb8eeb172ca876341ba89ed13e4fa2a1`
...
- decision_probs: `{"ABSTAIN": 0.2216, "NO": 0.6869, "YES": 0.0916}`
