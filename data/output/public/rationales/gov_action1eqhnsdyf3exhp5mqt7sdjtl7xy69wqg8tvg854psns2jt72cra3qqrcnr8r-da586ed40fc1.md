...
Score: `0.03` (raw `0.06` + doctrine-LLM nudge `-0.03`) | Confidence: `0.58` | Readiness: `0.0`
> Reasoning layer (codex-offline-review): Doctrine-aware offline lean for a parameter action: 4 well-supported claim(s), 2 unsupported high-materiality claim(s), parameter doctrine demands elevated scrutiny. Net bounded adjustment -0.030 (clamped to ±0.05).
...
## Reproducibility
- input_hash: `da586ed40fc1bbaa69a86aafbe8d3630f4cd7cbc46e5201ab05648ca9d3af39f`
- snapshot_bundle_hash: `34603c2dd9b6cc9629aa89a9b87d933cd4c99c8e12e7e2782ff2e64bd0e112ce`
...
- decision_probs: `{"ABSTAIN": 0.465, "NO": 0.2375, "YES": 0.2975}`
