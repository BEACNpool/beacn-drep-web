...
> Reasoning layer (precomputed): The extracted claims show plausible public-benefit alignment and some independently verifiable testnet/Catalyst traction, but the request is large and many high-materiality claims around mainnet readiness, adoption targets, revenue return, and Phase 2 execution remain forward-looking or proposer-asserted. Given the assessment marks claims and evidence as thin and overall status incomplete, a small cautionary nudge is justified without treating missing diligence as affirmative evidence of harm.
...
- finding: Requested: Fund Phase 1 of 2 for Bifrost, a Bitcoin-Cardano bridge, to move from working testnet toward launch readiness.
- finding: Recipient: FluidTokens and Lantr Engineering
- finding: Stated amount: 12332031
- finding: Deliverables: Hardening, security audits, and formal verification, Ecosystem and partner readiness, Stewardship and economic foundations for launch, Audited bridge running on Cardano mainnet in federated and SPO-threshold custody modes under controlled access, SPO/dApp partner pipeline required for public launch
...
- finding: Claim (technical, supported_in_proposal, high materiality): Bifrost custody of locked BTC is distributed across 400+ Cardano SPOs weighted by delegation, with movement of funds requiring a cryptographic threshold of SPOs representing the majority of delegated stake.
- finding: Claim (governance, supported_in_proposal, high materiality): Bifrost is structured as public infrastructure with no bridge token, no founder allocation, Apache 2 open-source components, public reporting, and an independent stewardship structure to be determined in Phase 1.
...
- missing: Independent evidence for: Bifrost targets by Q2 2029 include 1,200 BTC TVL, about 600,000 annual transactions, and 3,000 fBTC-holding wallets.
- missing: Independent evidence for: Bridge fees in fBTC are intended to fund operations, with surplus split to SPOs and the Cardano Treasury.
...
## Inferences
- Advisory model lean was -0.020 (display cap ±0.05) and had zero influence on the binding score: The extracted claims show plausible public-benefit alignment and some independently verifiable testnet/Catalyst traction, but the request is large and many high-materiality claims around mainnet readiness, adoption targets, revenue return, and Phase 2 execution remain forward-looking or proposer-asserted. Given the assessment marks claims and evidence as thin and overall status incomplete, a small cautionary nudge is justified without treating missing diligence as affirmative evidence of harm.
...
## Reproducibility
- input_hash: `0d84f7bf853ac90b7c1aa3d1d45e904e7d80d18b1b69be9536d05c3cb9cddcc6`
- snapshot_bundle_hash: `e7c9bdc24a3225f659c731766f5e25240fdf2fbb472ea125312e03c81e6555bd`
