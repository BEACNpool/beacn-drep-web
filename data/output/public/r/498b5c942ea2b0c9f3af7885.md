...
Recommendation: **NO**
Score: `-0.12` (raw `-0.56` + doctrine-LLM nudge `-0.03`) | Confidence: `0.75` | Readiness: `0.9`
> Reasoning layer (precomputed): The proposal contains concrete milestones, a detailed budget, and checkable future reporting mechanisms, but several high-materiality adoption, prior-investment, live-mainnet, and track-record claims are mostly proposer-asserted inside the document. The repayment commitment is positive for treasury stewardship, yet its exact revenue-base definition is deferred to later contracting, so evidence quality and downside protection justify a small cautionary nudge rather than a positive adjustment.
...
- finding: Recipient: Anvil Development Agency, Inc. with Intersect acting as budget administrator by prior agreement
- finding: Stated amount: 4,969,231
- finding: Deliverables: Secondary marketplace with on-chain settlement, Smart-contract-level royalty enforcement, Per-event anti-scalping controls, Custodial wallet onboarding inside Sellout's existing flow, Organizer tools and dashboard, Independent third-party security audit with report and remediation, Public launch campaign and trade-show activations, Public metrics dashboard and quarterly reporting, Revenue-share repayment mechanism to the Cardano Treasury
...
- finding: Claim (economic, supported_in_proposal, high materiality): The proposal requests 4,969,231 ada, approximately $1,093,231 at $0.22 per ADA, over 8 months and inclusive of a 3% Intersect administration fee.
- finding: Claim (technical, supported_in_proposal, high materiality): Phase 2 is intended to deliver a secondary marketplace, royalty enforcement, anti-scalping controls, wallet onboarding, organizer tools, a third-party security audit, and launch amplification.
...
- finding: Claim (economic, supported_in_proposal, high materiality): The exact revenue-base definition and repayment cadence are not finalized in the proposal and are deferred to M1 contracting with the appointed oversight committee.
...
- missing: Independent evidence for: The proposal projects 12-month launch targets of 200+ events on-chain, 75,000+ CIP-68 NFT tickets, 150,000+ on-chain interactions, $6M+ ticket revenue on-chain, and 20,000+ new wallets.
...
- status: `complete`
- finding: Strongest YES: the proposal substantiates "The proposal requests 4,969,231 ada, approximately $1,093,231 at $0.22 per ADA, over 8 months and inclusive of a 3% Intersect administration fee." and clears the evidence gates.
...
- Counterargument pass: Strongest YES: the proposal substantiates "The proposal requests 4,969,231 ada, approximately $1,093,231 at $0.22 per ADA, over 8 months and inclusive of a 3% Intersect administration fee." and clears the evidence gates.
- Synthesis: Final vote must be derived from completed sections above, not from a prose summary.

## Inferences
- Advisory model lean was -0.030 (display cap ±0.05) and had zero influence on the binding score: The proposal contains concrete milestones, a detailed budget, and checkable future reporting mechanisms, but several high-materiality adoption, prior-investment, live-mainnet, and track-record claims are mostly proposer-asserted inside the document. The repayment commitment is positive for treasury stewardship, yet its exact revenue-base definition is deferred to later contracting, so evidence quality and downside protection justify a small cautionary nudge rather than a positive adjustment.
...
## Reproducibility
- input_hash: `934342af0542004775056389434b73324cd0566b317668eaa76e1beb66142550`
- snapshot_bundle_hash: `35f7cbcd655598b9c09c2f35b5551d6f2e81f5cba17d8d3a0c4d3b17930b7e90`
