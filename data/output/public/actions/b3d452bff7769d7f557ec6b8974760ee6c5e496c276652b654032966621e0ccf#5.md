...
- Provide independent evidence for: The proposer claims Mithril enables rapid state verification for nodes and applications without relying on the entire chain.
- Provide independent evidence for: The proposal states that faster sync times would reduce onboarding friction and unlock tooling for exchanges, wallets, and monitoring.
