...
- Provide independent evidence for: The proposal says Bifrost is already live on testnet under Catalyst Fund 14 with working peg-ins and peg-outs and participating SPOs.
- Provide independent evidence for: Bifrost's smart contracts, off-chain tooling, and SDK are stated to be open source under Apache 2.0.
