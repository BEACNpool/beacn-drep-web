...
> Reasoning layer (precomputed): The extracted claims show plausible public-benefit ecosystem value, but the evidence quality is uneven for a large treasury withdrawal: key usage, transaction-share, free-tier, feasibility, risk, and sustainability claims are mostly proposer-asserted, and the budget table contains an apparent column inconsistency. Given the deterministic assessment is already blocked for missing proposal summary, budget analysis, feasibility assessment, risk analysis, alternatives analysis, and failure-mode analysis, only a small additional cautionary nudge is justified.
...
The action is a TreasuryWithdrawals. The cached anchor describes the request as: Transition Blockfrost into a free, community-governed public good under an independent not-for-profit, including 18 months of transition and operations.. The recorded treasury amount is 9,832,979 ADA. The strongest grounded claim is: The proposal states that Blockfrost usage in the Cardano Foundation developer ecosystem survey rose from 39.3% in 2022 to 71.5% in 2025, with links to each survey year.
...
- finding: Claim (adoption, independently_verifiable, high materiality): The proposal states that Blockfrost usage in the Cardano Foundation developer ecosystem survey rose from 39.3% in 2022 to 71.5% in 2025, with links to each survey year.
...
- finding: Claim (technical, proposer_asserted, high materiality): The proposal claims that in most Cardano epochs more than 50% of all transactions are submitted through Blockfrost.
...
- finding: Claim (economic, proposer_asserted, high materiality): The proposal states that 90% of all Cardano traffic served through the Blockfrost API comes from the free tier, making the commercial model difficult for financing the public-good operation.
...
- missing: Independent evidence for: The proposal claims that in most Cardano epochs more than 50% of all transactions are submitted through Blockfrost.
...
- status: `complete`
- finding: Strongest YES: the proposal substantiates "The proposal states that Blockfrost usage in the Cardano Foundation developer ecosystem survey rose from 39.3% in 2022 to 71.5% in 2025, with links to each survey year." and clears the evidence gates.
...
- Counterargument pass: Strongest YES: the proposal substantiates "The proposal states that Blockfrost usage in the Cardano Foundation developer ecosystem survey rose from 39.3% in 2022 to 71.5% in 2025, with links to each survey year." and clears the evidence gates.
- Synthesis: Final vote must be derived from completed sections above, not from a prose summary.

## Inferences
- Doctrine-aware reasoning layer nudged the score by -0.030 (clamped to ±0.05): The extracted claims show plausible public-benefit ecosystem value, but the evidence quality is uneven for a large treasury withdrawal: key usage, transaction-share, free-tier, feasibility, risk, and sustainability claims are mostly proposer-asserted, and the budget table contains an apparent column inconsistency. Given the deterministic assessment is already blocked for missing proposal summary, budget analysis, feasibility assessment, risk analysis, alternatives analysis, and failure-mode analysis, only a small additional cautionary nudge is justified.
...
## Reproducibility
- input_hash: `4ee98dda05bfc689bb93661786c7f04a141db3c8e24fe6afda7e50b59a55f6c3`
- snapshot_bundle_hash: `ce224e7910675f8a9f34b7409041dc58fabae2edc7ce0ac247d49d4fb145993f`
