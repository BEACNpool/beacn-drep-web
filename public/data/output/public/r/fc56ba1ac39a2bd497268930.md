...
> Reasoning layer (precomputed): The claims show a large treasury deployment with plausible public-benefit growth and some proposed controls, but the deterministic assessment is blocked by missing budget, feasibility, risk, alternatives, and failure-mode analysis. Evidence quality is weakened because key adoption and market claims are asserted without references in the anchor, the audit is not yet completed in-document, and the structure converts ADA into USDM while exposing treasury principal to stablecoin, custody, smart contract, and opportunity-cost risks. A small negative nudge is justified because treasury stewardship and evidence reproducibility remain weaker than the requested scale warrants.
...
- finding: Claim (economic, supported_in_proposal, high materiality): The deployment is modeled to generate approximately 135,000 USD or 900,000 ADA-equivalent in annual yield at a 10% USD-denominated APR, but returns are not guaranteed.
...
- finding: Claim (adoption, proposer_asserted, medium materiality): The document claims Strike represented over 50% of Cardano trading activity during the past six months.
- finding: Claim (adoption, supported_in_proposal, high materiality): Strike V2 data from March 20, 2026 through June 15, 2026 is presented as evidence of accelerating volume, revenue, trades, users, and open interest as liquidity increased.
...
- missing: Independent evidence for: The proposal states Strike V2 has unofficial technical reviews and an official audit by Christian Schmitz expected to be finalized by July 1, 2026, but the completed audit is not included in the document.
...
## Inferences
- Doctrine-aware reasoning layer nudged the score by -0.030 (clamped to ±0.05): The claims show a large treasury deployment with plausible public-benefit growth and some proposed controls, but the deterministic assessment is blocked by missing budget, feasibility, risk, alternatives, and failure-mode analysis. Evidence quality is weakened because key adoption and market claims are asserted without references in the anchor, the audit is not yet completed in-document, and the structure converts ADA into USDM while exposing treasury principal to stablecoin, custody, smart contract, and opportunity-cost risks. A small negative nudge is justified because treasury stewardship and evidence reproducibility remain weaker than the requested scale warrants.
...
## Reproducibility
- input_hash: `1bd6ea76b69927b568d67538685aaf588be3d0553f0ec3c9f0b1b62370fefdc4`
- snapshot_bundle_hash: `a7ef258483fe8493fb48727466ebbf7c8e386be4a6390158a2a8b535489bc6ff`
