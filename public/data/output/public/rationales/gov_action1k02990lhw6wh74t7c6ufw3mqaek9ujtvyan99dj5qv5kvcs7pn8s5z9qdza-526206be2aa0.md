...
> Reasoning layer (precomputed): The claims show plausible public-benefit infrastructure work and some governance references, but the deterministic assessment is blocked by missing budget, feasibility, risk, alternatives, and failure-mode analysis; under BEACN doctrine this warrants a small cautionary nudge against spending despite the stated oversight and NCL compliance.
...
- finding: Requested: Treasury withdrawal to fund UTxO RPC by TxPipe for maintaining Cardano's integration standard over Year 2.
...
- finding: Claim (technical, supported_in_proposal, medium materiality): UTxO RPC is described as an open interface specification using Protocol Buffers with SDKs in Rust, Go, Node.js, .NET, Haskell, and Python.
...
- finding: Claim (technical, proposer_asserted, medium materiality): The project is said to maintain more than 10 repositories covering the core specification, SDKs, documentation, and provider integrations under the Apache 2.0 license.
- finding: Claim (technical, supported_in_proposal, high materiality): The maintainer scope includes specification maintenance, SDK maintenance, community support, and improved AI-friendly documentation and integration resources.
- finding: Claim (governance, independently_verifiable, high materiality): The proposer states the proposal achieved the required 67% support threshold in the 2026 Intersect Budget Process Hydra Voting phase and provides references to voting and audit materials.
...
- missing: Independent evidence for: The project is said to maintain more than 10 repositories covering the core specification, SDKs, documentation, and provider integrations under the Apache 2.0 license.
...
## Inferences
- Doctrine-aware reasoning layer nudged the score by -0.030 (clamped to ±0.05): The claims show plausible public-benefit infrastructure work and some governance references, but the deterministic assessment is blocked by missing budget, feasibility, risk, alternatives, and failure-mode analysis; under BEACN doctrine this warrants a small cautionary nudge against spending despite the stated oversight and NCL compliance.
...
- Claims and evidence missing: Independent evidence for: The project is said to maintain more than 10 repositories covering the core specification, SDKs, documentation, and provider integrations under the Apache 2.0 license.
...
## Reproducibility
- input_hash: `526206be2aa0688e2f3c5f461f6e6a701090e0379edc3c683b2e6b7308758d85`
- snapshot_bundle_hash: `789bf04a5308b5517ebcdd27c669adb5b2cf82a898edb1f79fb41d241165e69d`
