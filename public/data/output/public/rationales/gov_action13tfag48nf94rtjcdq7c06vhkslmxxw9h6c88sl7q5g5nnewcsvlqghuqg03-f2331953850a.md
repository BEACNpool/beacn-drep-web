...
BEACN records NO on Withdraw ₳220,914 for Pallas: Sustaining Critical Rust Tooling for Cardano. On the evidence available to BEACN's published review, the request does not clear the bar for spending shared treasury funds.
