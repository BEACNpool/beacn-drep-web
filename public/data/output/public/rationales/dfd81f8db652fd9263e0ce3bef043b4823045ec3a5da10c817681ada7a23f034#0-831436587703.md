...
> Reasoning layer (precomputed): The extracted claims describe a high-value bridge handling BTC custody and a large treasury withdrawal, while the deterministic assessment marks claims and evidence as thin. Under the doctrine's hierarchy, protocol safety, treasury stewardship, and reproducible evidence outweigh public-benefit growth claims, so the bounded adjustment should lean slightly cautious without overriding the engine's gates.
...
- finding: Requested: Phase 1 of 2 funding to take Bifrost from working testnet to launch readiness for a Bitcoin-Cardano bridge.
...
- finding: Claim (economic, supported_in_proposal, high materiality): The proposers request ₳12,332,031, described as approximately $1,973,125 at 0.16 USD/ADA including a 10% refundable contingency, for a 9-month Phase 1 delivery period.
...
- finding: Claim (technical, proposer_asserted, high materiality): Custody of locked BTC is claimed to be distributed across 400+ Cardano SPOs weighted by delegation, with fund movement requiring a cryptographic threshold representing a majority of delegated stake.
- finding: Claim (technical, proposer_asserted, high materiality): If SPO coordination fails, Bifrost claims a federated mode can activate as an operational fallback.
...
- missing: Independent evidence for: Custody of locked BTC is claimed to be distributed across 400+ Cardano SPOs weighted by delegation, with fund movement requiring a cryptographic threshold representing a majority of delegated stake.
- missing: Independent evidence for: If SPO coordination fails, Bifrost claims a federated mode can activate as an operational fallback.
- missing: Independent evidence for: The proposal states Bifrost has no bridge token, no founder allocation, Apache 2.0 open-source components, public reporting, and an independent stewardship structure to be determined in Phase 1.
...
## Inferences
- Advisory model lean was -0.030 (display cap ±0.05) and had zero influence on the binding score: The extracted claims describe a high-value bridge handling BTC custody and a large treasury withdrawal, while the deterministic assessment marks claims and evidence as thin. Under the doctrine's hierarchy, protocol safety, treasury stewardship, and reproducible evidence outweigh public-benefit growth claims, so the bounded adjustment should lean slightly cautious without overriding the engine's gates.
...
## Reproducibility
- input_hash: `831436587703deb96931ea3d4125a060282db8173b61235a0cc4ffc9393548b6`
- snapshot_bundle_hash: `7b473ab56542dea1a9003f092fc7fff9ee0a963bb8913a0108b82c036d7072dd`
