...
> Reasoning layer (precomputed): The request is framed as a reimbursement rather than new project spending, but the evidence remains thin for key treasury-relevant points: the node-bug causation, recipient identity, prior non-receipt of treasury funds, NCL adherence, and the staking-reward calculation are mostly asserted rather than substantiated in the document. Given the deterministic assessment is already blocked for missing budget, feasibility, alternatives, failure-mode, and community-impact analysis, only a small negative nudge is justified for weak reproducibility and treasury stewardship concerns.
...
- finding: Deliverables: Instant on-chain treasury withdrawal to reimburse the lost Info governance action deposit, Additional compensation for estimated lost staking rewards
...
- finding: Claim (technical, proposer_asserted, high materiality): The submitter could not recover the 100,000 ADA deposit because a Cardano node bug permitted an unregistered stake key to be used in the governance action.
...
- finding: Claim (economic, supported_in_proposal, medium materiality): The requested 3,000 ADA staking-reward compensation is calculated at a rate of 2% per annum.
...
- missing: Independent evidence for: The submitter could not recover the 100,000 ADA deposit because a Cardano node bug permitted an unregistered stake key to be used in the governance action.
...
- Claims and evidence missing: Independent evidence for: The submitter could not recover the 100,000 ADA deposit because a Cardano node bug permitted an unregistered stake key to be used in the governance action.
...
## Reproducibility
- input_hash: `6fa3b41f11dc9996d1b6b2d1f6ce11ce721f55d4f69be58a3bcace22c2cc326c`
- snapshot_bundle_hash: `d5ff2ac442f5184525613d958d8093a2ea4f681090aba98eaad2a1d21c4d85b1`
